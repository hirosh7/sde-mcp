...
export function registerDiagramTools(
  ...
  server.registerTool(
    ...
    async ({ project_id }) => {
      const result = await client.get(`projects/${project_id}/diagrams/`);
  ...
  server.registerTool(
    ...
    async ({ diagram_id }) => {
      const result = await client.get(`project-diagrams/${diagram_id}/`);
  ...
  server.registerTool(
    ...
    async ({ project_id, name, diagram_data }) => {
      ...
      const result = await client.apiRequest("POST", "project-diagrams/", data);
