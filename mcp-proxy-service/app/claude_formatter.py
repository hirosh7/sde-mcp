...
class ClaudeResponseFormatter:
    ...
    async def format_result(self, tool_name: str, result: Dict[str, Any], original_query: str) -> str:
        """
...
Your task is to convert JSON tool results into clear, concise natural language responses.
...
Format this result into natural language:"""
